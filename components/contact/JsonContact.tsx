          ...
          <form onSubmit={handleSubmit} className="p-6 md:p-10 font-mono relative">
            ...
            <div className="mt-10 md:mt-16 flex flex-col md:flex-row items-stretch md:items-center justify-between gap-6 md:gap-10 border-t border-white/5 pt-8 md:pt-10">
              ...
              <motion.button 
                ...
                whileTap={{ scale: 0.98 }}
                className={`w-full md:w-auto px-6 md:px-10 py-4 md:py-5 rounded-xl md:rounded-2xl font-black text-[10px] md:text-[11px] tracking-[0.2em] md:tracking-[0.3em] uppercase transition-all duration-500 flex items-center justify-center gap-3 ${
